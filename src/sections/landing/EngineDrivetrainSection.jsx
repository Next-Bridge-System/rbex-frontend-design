    ...
    return (
        <section className="text-gray-800 p-10 mb-10">
            ...
            <div className="w-full px-4 lg:px-16 lg:mb-0 mb-4">
                <div className="max-w-8xl mx-auto flex flex-col lg:flex-row justify-between items-center lg:h-[120px] gap-6">
                    {/* Left: Category Buttons */}
                    <div className="flex gap-4 lg:ml-52">
                        <button 
                            className="bg-strip text-sm px-10 py-4 text-white rounded-full hover:bg-red-600"
                            onClick={() => {
            ...
            <div className="relative overflow-hidden max-w-8xl mx-auto">
                <div className="flex transition-transform duration-300" style={{ 
                    ...
                    <div className="w-1/3 px-2 flex-shrink-0">
                        <aside
                            className="w-full h-[570px] text-white p-4 rounded bg-cover bg-center flex flex-col justify-between"
                        ...
                        >
                            ...
                            <button
                                className="relative py-4 w-[75%] mx-auto mb-5 text-lg rounded text-white overflow-hidden group bg-gradient-to-r from-red-600 via-red-700 to-red-600 hover:from-red-700 hover:to-red-800 transition"
                                onClick={() => {
                                    navigate('/shop-by-category');
                                    window.scrollTo(0, 0);
                                }}
                    ...
                    {products.map(({ id, name, price, image }, index) => {
                        ...
                        return (
                            ...
                            >
                                <div className="w-full bg-white h-[550px] lg:h-[600px] shadow border-gray-200 border rounded p-3 hover:shadow-md">
                                    ...
                                    <div className="flex justify-center mt-6">
                                        {quantity === 0 ? (
                                            <button
                                                onClick={increment}
                                                className="bg-strip text-white py-3 px-12 text-xs lg:text-lg rounded hover:bg-red-600 transition-colors"
                                            >
                                                Add to cart
                                            </button>
                                        ) : (
