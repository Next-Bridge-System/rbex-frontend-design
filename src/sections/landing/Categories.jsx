    ...
    <section className="bg-[#F4FDFF] py-12 px-4">
      <div className="max-w-8xl mx-auto">
        ...
        <div className="flex flex-col p-10 sm:flex-row justify-between items-center  gap-4 sm:gap-0">
          <h2 className="text-3xl font-medium text-[#333333] text-center sm:text-left">
            Shop by category
          </h2>
          <button className="bg-strip hover:bg-red-700 text-white px-7 py-3 rounded-lg text-sm font-medium"
            onClick={() => {
        ...
        {/* Grid */}
        <div className="grid grid-cols-1  w-[90%] mx-auto sm:grid-cols-2 md:grid-cols-3 gap-x-6 gap-y-10">
