    ...
    <section className="bg-[#F4FDFF] py-12 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col p-10 sm:flex-row justify-between items-center  gap-4 sm:gap-0">
          ...
          <button className="bg-strip hover:bg-red-700 text-white px-7 py-2 rounded-lg text-xs font-medium"
            onClick={() => {
        ...
        {/* Grid */}
        <div className="grid grid-cols-1  w-[80%] mx-auto sm:grid-cols-2 md:grid-cols-3 gap-x-6 gap-y-10">
